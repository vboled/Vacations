...
JOBS = {
    # Chongqing
    "cq_hongyadong":  ("Hongya Cave Chongqing night", 5),
    "cq_liziba":      ("Chongqing Rail Transit Line 2 Liziba building", 4),
    "cq_raffles":     ("Raffles City Chongqing Chaotianmen", 4),
    "cq_ciqikou":     ("Ciqikou Ancient Town Chongqing", 5),
    "cq_yangtze":     ("Yangtze River Cableway Chongqing", 4),
    # Zhangjiajie
    ...
    "ys_longji":      ("Longji Rice Terraces Longsheng", 4),
    # Guangzhou
